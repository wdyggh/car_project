...
const NACK = '9';
var auto_test_timer;
var wsUri = 'ws://220.69.240.247:8001';
//var wsUri = 'ws://220.68.139.15:8001';

var websocket;
var total_step_count = 2500;
var step_unit_step = parseInt(2500/1000);
var maual_toggle=0;
var manual_on_el;
var manual_off_el;
var auto_toggle=0;
...
function background_img_draw() {
	ctx.roundRect(80, 100, 1300, 400);
	ctx.roundRect(300, 100, 900, 300);
}
...
function fun()
{
	...
	$("#manual").click(function() {
		...
		if ( maual_toggle == 0 ) {
			...
			maual_toggle = 1;
			manual_on_el.disabled=false;
			manual_off_el.disabled=true;
			// $("#manual_off").hide();
		} else {
			console.log('manual off');
			manual_on_el.disabled=true;
			manual_off_el.disabled=false;
			maual_toggle = 0;
		}
	});
	...
	$("#auto").click(function() {
		...
		if ( auto_toggle == 0 ) {
			...
			// auto_test_timer = setInterval( auto_tx_func, 200);
			auto_toggle = 1;
			auto_on_el.disabled=false;
			auto_off_el.disabled=true;
		} else {
			console.log('auto off');
			auto_id = 1;
			// clearInterval(auto_test_timer);
			auto_toggle = 0;
			auto_on_el.disabled=true;
			auto_off_el.disabled=false;
		}
...
$(document).ready(function() {
	...
	*/
	...
	// init html
	manual_on_el=document.getElementById("manual_on");
	manual_off_el=document.getElementById("manual_off");
	auto_on_el=document.getElementById("auto_on");
	auto_off_el=document.getElementById("auto_off");
	init_html();
